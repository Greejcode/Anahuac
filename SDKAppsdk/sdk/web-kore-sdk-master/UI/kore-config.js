(function(KoreSDK){
    ...
    botOptions.userIdentity = 'carlos.maya@realitycx.com';// Provide users email id here
    botOptions.botInfo = { name: "Anáhuac", "_id": "st-4a6c7879-06ee-588e-9756-591ad2e70c85" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "cs-5fd5b156-9750-5d3c-aab9-ec42ff5b0a9f";
    botOptions.clientSecret = "ZRSgWpVmrMsleayUG+jsXTxzGYhZRa9eBozDKtIQyeA=";
